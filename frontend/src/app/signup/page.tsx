...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to home page - it will handle role-based routing
      router.push('/');
    } catch (err) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Note: Google sign-in users will get userType set in AuthContext
      // Default is 'customer', they can change it later at /update-user-type
      router.push('/');
    } catch (err) {
            ...
            <fieldset className="space-y-3">
              ...
              <div className="flex space-x-6">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="customer" className="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Customer
                  </label>
                </div>
                <div className="flex items-center">
