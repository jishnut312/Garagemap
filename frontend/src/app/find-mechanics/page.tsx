...
import { Search, MapPin, Phone, Star, Filter, Wrench, ArrowRight } from 'lucide-react';
...
export default function FindMechanicsPage() {
    ...
    const handleRequestService = async (mechanicId: string) => {
        ...
        try {
            ...
            await createRequest({
                ...
                serviceType: 'general',
                status: 'pending',
                description: 'Service request from find mechanics page',
            });
    ...
    return (
        <div className="min-h-screen bg-slate-50">
                    ...
                    <div className="flex justify-between items-center py-4">
                        ...
                        <div className="flex items-center space-x-6">
                            <div className="hidden md:flex items-center space-x-4">
                                ...
                                <a href="/find-mechanics" className="text-white font-medium transition-colors">Find Mechanics</a>
                            ...
                            {user ? (
                                <div className="flex items-center gap-3 pl-6 border-l border-slate-700">
                                    <div className="text-right hidden sm:block">
                                        ...
                                        <p className="text-xs text-slate-400 capitalize">{user.userType || 'Customer'}</p>
                                    </div>
            ...
            {/* Hero Section */}
            <div className="bg-slate-900 pb-12 pt-10 px-4 sm:px-6 lg:px-8 -mt-1">
                <div className="max-w-7xl mx-auto">
                    <h1 className="text-4xl font-bold text-white mb-4">Find the Best Mechanics</h1>
                    <p className="text-slate-400 text-lg max-w-2xl">
                        Discover top-rated workshops and mobile mechanics near you. View photos, compare ratings, and book services instantly.
                    </p>
                </div>
            </div>
                            ...
                            <div key={mechanic.id} className="bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:border-red-100 transition-all duration-300 group overflow-hidden flex flex-col">
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    ...
                                    <div className="flex flex-wrap gap-2 my-4">
                                        {mechanic.services && mechanic.services.slice(0, 3).map((service) => (
                                            <span
                                                key={service}
